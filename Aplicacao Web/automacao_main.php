...
<body onload="MQTTconnect(),atualiza()">
    <div id="status" style="font-size:16px;color:white">Conectando...</div>
    
    <h4>AUTOMAÇÃO RESIDENCIAL</h4>
    <div id="status_dis" style="font-size:18px;color:white">Aguardando dispositivo...</div>
    <!---<i id="coneccao" class="fa fa-wifi" style="font-size:36px;color:yellow"></i><br>-->
    <!--<div id="notficacao">
        <span id="status_dis">Aguardando dispositivo - </span><span id="hour">00</span>:<span id="minute">00</span>:<span id="second">00</span>:<span id="millisecond">000</span>
    </div>-->
    ...
    <div class="central" style="width: 45%; float:right">
        ...
        <div class="config">
            ...
            <table>
                <h2>Intervalo de tempo de notificação</h2>
                <tr>
                    <td>Tempo em minutos:</td>
                    <td><input id="tempoNotificacao" type="number" value=""></td>
                </tr>
            </table>
            <button style="margin-bottom: 10px;" onclick="send_notif_configuration()" id="botao">Salvar</button>
        </div>
